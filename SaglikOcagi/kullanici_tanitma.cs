...
namespace SaglikOcagi
{
    public partial class kullanici_tanitma : Form
    {
        ...
        public void KayitliKullaniciEkranaBas()
        {
            try
            {
                cmd = new SqlCommand("SELECT userName From dbo.kullanici", baglan);
                baglan.Open();
        ...
        public bool KullaniciTanitmaKullaniciEkraniAc(string kullanici_userName)
        {
            try
            {
                cmd = new SqlCommand("SELECT * From dbo.kullanici WHERE userName = @kullanici_userName", baglan);
        ...
        private void YeniKullaniciEkleme()
        {
            ...
            if (poliklinik_ac_bool == true)
            {
                try
                {
                    cmd = new SqlCommand("INSERT INTO dbo.kullanici (userName) VALUES (@aranan_kullanici)", baglan);
