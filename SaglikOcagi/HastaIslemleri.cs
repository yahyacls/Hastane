    ...
    public partial class HastaIslemleri : Form
    {
        ...
        private string DoktorAdSorgulama()
        {
            try
            {
                ...
                cmd = new SqlCommand("SELECT kullanici.ad FROM dbo.kullanici WHERE unvan = 'doktor' AND kullaniciKod=@DOKTOR_KOD", baglan);
        ...
        private void comboBox4_DoktorKod_SelectedIndexChanged(object sender, EventArgs e)
        {
